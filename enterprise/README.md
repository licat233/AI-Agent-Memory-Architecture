...
2. Set up core files such as `Core-Memory.md`, `Hermes-Operating-Protocol.md`, `Source-of-Truth-Map.md`, `Permission-Policy.md`, `Retrieval-Rules.md`, `Memory-Write-Router.md`, `Root-Cause-Fix-Protocol.md`, `Runtime-Memory-Policy.md`, `Lifecycle-Policy.md`, and `Governance-Patch-V715.md`.
...
1. 创建上方冻结 Vault 结构。
2. 建立核心文件，例如 `Core-Memory.md`、`Hermes-Operating-Protocol.md`、`Source-of-Truth-Map.md`、`Permission-Policy.md`、`Retrieval-Rules.md`、`Memory-Write-Router.md`、`Root-Cause-Fix-Protocol.md`、`Runtime-Memory-Policy.md`、`Lifecycle-Policy.md` 和 `Governance-Patch-V715.md`。
