...
![ARMOR Enterprise AI Workspace architecture overview](../assets/armor-enterprise-architecture-overview.svg)

### Mind Map

![ARMOR Enterprise AI Workspace mind map](../assets/armor-enterprise-memory-mindmap.svg)
...
![ARMOR 企业 AI 记忆架构总览图](../assets/armor-enterprise-architecture-overview.svg)

### 架构思维导图

![ARMOR 企业 AI 记忆架构思维导图](../assets/armor-enterprise-memory-mindmap.svg)
...
| [Prompt Intake Router](Prompt_Intake_Router.md) | 用于模糊或高风险 prompt 的第一入口意图路由器 |
