...
>
> Applies to: AI Agent Memory Architecture v1.3.0, ARMOR Enterprise V7.2 Stable.
...
For complex ARMOR project work, use the lightweight project execution templates from AI Agent Memory Architecture v1.3.0.
