...
| --- | --- | --- | --- |
| [ARMOR Enterprise AI Workspace](docs/enterprise/README.md) | V7.1 Stable + V7.1.5 Governance Patch | Teams, business operations, brand/product/customer knowledge, multi-agent workspaces | Stable |
| [PAMA Personal AI Memory Architecture](docs/personal/README.md) | V5.1 Stable | Individual knowledge, decision review, attention auditing, personal reality tracking | Stable |
...
1. Choose the architecture branch that matches your use case: [Enterprise](docs/enterprise/README.md) or [Personal](docs/personal/README.md).
...
| --- | --- |
| [Enterprise README](docs/enterprise/README.md) | Enterprise overview, ARMOR quick start, permission model, lifecycle rules |
| [ARMOR V7.1 Stable](docs/enterprise/V7_1_Stable.md) | Full enterprise architecture specification |
| [ARMOR V7.1.5 Governance Patch](docs/enterprise/V7_1_5_Governance_Patch.md) | Confidence labels, fact creation gate, write quality rules |
| [Hermes Adaptation Guide](docs/enterprise/hermes_adaptation_guide.md) | How to adapt Hermes-style agents to ARMOR |
| [Personal README](docs/personal/README.md) | PAMA overview, personal vault layers, promotion rules |
| [PAMA V5.1 Stable](docs/personal/PAMA%20V5.1%20Stable.md) | Full personal architecture specification |
| [PAMA Constitution](docs/personal/PAMA%20Constitution%20v1.0.md) | Highest-level personal architecture charter |
| [PAMA Deployment Spec](docs/personal/PAMA-Deployment-Spec-v1.0.md.md) | Personal vault implementation and metadata rules |
...
| 分支 | 版本 | 场景 | 状态 |
| --- | --- | --- | --- |
| [ARMOR 企业级 AI 工作空间](docs/enterprise/README.md) | V7.1 Stable + V7.1.5 Governance Patch | 团队、业务运营、品牌/产品/客户知识、多智能体工作区 | 稳定 |
| [PAMA 个人 AI 记忆架构](docs/personal/README.md) | V5.1 Stable | 个人知识、决策复盘、注意力审计、现实追踪 | 稳定 |
...
1. 根据使用场景选择架构分支：[企业版](docs/enterprise/README.md) 或 [个人版](docs/personal/README.md)。
...
| 文档 | 说明 |
| --- | --- |
| [企业版 README](docs/enterprise/README.md) | 企业版总览、ARMOR 快速开始、权限模型、生命周期规则 |
| [ARMOR V7.1 Stable](docs/enterprise/V7_1_Stable.md) | 企业级完整架构规范 |
| [ARMOR V7.1.5 Governance Patch](docs/enterprise/V7_1_5_Governance_Patch.md) | 置信度标签、事实创建门禁、写入质量规则 |
| [Hermes 适配指南](docs/enterprise/hermes_adaptation_guide.md) | Hermes 类智能体如何接入 ARMOR |
| [个人版 README](docs/personal/README.md) | PAMA 总览、个人 Vault 层级、记忆晋升规则 |
| [PAMA V5.1 Stable](docs/personal/PAMA%20V5.1%20Stable.md) | 个人版完整架构规范 |
| [PAMA 宪法](docs/personal/PAMA%20Constitution%20v1.0.md) | 个人版最高治理章程 |
| [PAMA 部署规范](docs/personal/PAMA-Deployment-Spec-v1.0.md.md) | 个人 Vault 落地与元数据规则 |
