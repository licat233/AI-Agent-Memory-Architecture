...
ARMOR is a reusable enterprise architecture, not a company-specific deployment. Any organization can adapt it to its own brand, product, customer, operations, research, and project knowledge.
...
ARMOR 是可复用的企业级记忆架构，不是某一家公司的内部部署方案。任何组织都可以将它适配到自己的品牌、产品、客户、运营、研究和项目知识中。
