# AI Agent Memory Architecture v1.0.0
...
| [PAMA Personal AI Memory Architecture](personal/README.md) | V5.2 Stable | Individual knowledge, decision review, attention auditing, personal reality tracking | Stable |
...
| [PAMA 个人 AI 记忆架构](personal/README.md) | V5.2 Stable | 个人知识、决策复盘、注意力审计、现实追踪 | 稳定 |
