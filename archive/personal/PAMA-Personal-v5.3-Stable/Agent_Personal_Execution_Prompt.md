...
>
> Applies to: AI Agent Memory Architecture v1.5.0, PAMA Personal V5.3 Stable.
...
For complex PAMA personal work, use the lightweight personal execution templates from AI Agent Memory Architecture v1.5.0.
